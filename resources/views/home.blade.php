            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4>Data za Darsa Iliyopo Live Now</h4>
                    </div>
                    <div class="py-2 px-5">
                        <a href="#!" class="btn btn-primary btn-sm"
                            onclick="document.getElementById('add_broadcast').submit()"><i
                                class="feather icon-edit"></i>&nbsp;Add New </a>
                        <form id="add_broadcast" method="POST" action="{{ route('add_broadcast') }}">@csrf @method('POST')
                        </form>
                            ...
                            <tbody class="px-3 py-3">
                                ...
                                <tr>
                                    ...
                                    <div class="row border-bottom-1">
                                        <div class="col-4 border-right">Title</div>
                                        <div class="col-8">{{ $broadcast->title }}</div>
                                    </div><hr>
                                    <div class="row border-bottom-1">
                                        <div class="col-4 border-right">Book</div>
                                        <div class="col-8">{{ $broadcast->book }}</div>
                                    </div><hr>
                                    <div class="row border-bottom-1">
                                        <div class="col-4 border-right">Teacher</div>
                                        <div class="col-8">{{ $broadcast->teacher }}</div>
                                    </div><hr>
                                    <div class="row border-bottom-1">
                                        <div class="col-4 border-right">Extra</div>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="modal fade text-left" id="edit-broadcast-modal-{{ $broadcast->id }}">
